/****************************************************************************
 *   $Id:: spi.h 5741 2010-11-30 23:13:47Z usb00423                         $
 *   Project: NXP LPC17xx SSP example
 *
 *   Description:
 *     This file contains SSP code header definition.
 *
 *   Le Dang Dung : This is a modified version of ssp example. I added a simple
 *   transfer method in case we need to send a single byte to peripheral dev
 ****************************************************************************
...
extern uint8_t SPI_transfer(uint8_t portnum, uint8_t _data);
#endif  /* __SPI_H__ */
/*****************************************************************************
**                            End Of File
******************************************************************************/
